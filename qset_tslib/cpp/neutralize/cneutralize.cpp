...
#define __PYX_HAVE__barsim__tools__cneutralize
#define __PYX_HAVE_API__barsim__tools__cneutralize
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* "barsim/tools/cneutralize.pyx":9
 * 
 * DTYPE = np.float
 ...
 */
typedef __pyx_t_5numpy_float_t __pyx_t_6barsim_5tools_11cneutralize_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
struct __pyx_opt_args_6barsim_5tools_11cneutralize_neutralize_row;
struct __pyx_opt_args_6barsim_5tools_11cneutralize__neutralize;

/* "barsim/tools/cneutralize.pyx":16
...
/* "barsim/tools/cneutralize.pyx":60
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
/* Module declarations from 'barsim.tools.cneutralize' */
static PyArrayObject *__pyx_f_6barsim_5tools_11cneutralize_neutralize_row(PyArrayObject *, PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6barsim_5tools_11cneutralize_neutralize_row *__pyx_optional_args); /*proto*/
static PyArrayObject *__pyx_f_6barsim_5tools_11cneutralize__neutralize(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6barsim_5tools_11cneutralize__neutralize *__pyx_optional_args); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t = { "uint8_t", NULL, sizeof(__pyx_t_5numpy_uint8_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_uint8_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_uint8_t), 0 };
#define __Pyx_MODULE_NAME "barsim.tools.cneutralize"
extern int __pyx_module_is_main_barsim__tools__cneutralize;
int __pyx_module_is_main_barsim__tools__cneutralize = 0;

/* Implementation of 'barsim.tools.cneutralize' */
...
static PyObject *__pyx_pf_6barsim_5tools_11cneutralize_neutralize_row(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_v, PyObject *__pyx_v_isfinite, PyObject *__pyx_v_group, bool __pyx_v_norm_std); /* proto */
static PyObject *__pyx_pf_6barsim_5tools_11cneutralize_2_neutralize(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_v, PyArrayObject *__pyx_v_group, bool __pyx_v_norm_std); /* proto */
...
static PyObject *__pyx_pw_6barsim_5tools_11cneutralize_1neutralize_row(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_6barsim_5tools_11cneutralize_neutralize_row(PyArrayObject *__pyx_v_v, PyObject *__pyx_v_isfinite, PyObject *__pyx_v_group, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6barsim_5tools_11cneutralize_neutralize_row *__pyx_optional_args) {
  ...
  __pyx_t_6barsim_5tools_11cneutralize_DTYPE_t __pyx_t_30;
  ...
  __pyx_pybuffernd_v.rcbuffer = &__pyx_pybuffer_v;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_v.rcbuffer->pybuffer, (PyObject*)__pyx_v_v, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 16, __pyx_L1_error)
  }
  ...
  /* "barsim/tools/cneutralize.pyx":17
 * @cython.wraparound(False)
 * cpdef np.ndarray[double] neutralize_row(np.ndarray[DTYPE_t, ndim=1] v, list isfinite, list group, bool norm_std=False):
 *     cdef int n_ids = 0             # <<<<<<<<<<<<<<
 *     cdef int n = v.shape[0]
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":18
 * cpdef np.ndarray[double] neutralize_row(np.ndarray[DTYPE_t, ndim=1] v, list isfinite, list group, bool norm_std=False):
 *     cdef int n_ids = 0
 *     cdef int n = v.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":22
 *     cdef map[int, int] ids
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         if isfinite[i] == 1:
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "barsim/tools/cneutralize.pyx":23
 * 
 *     for i in range(n):
 *         if isfinite[i] == 1:             # <<<<<<<<<<<<<<
 *             if ids.find(group[i]) == ids.end():
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      /* "barsim/tools/cneutralize.pyx":24
 *     for i in range(n):
 *         if isfinite[i] == 1:
 *             if ids.find(group[i]) == ids.end():             # <<<<<<<<<<<<<<
 *                 ids[group[i]] = n_ids
 ...
 */
      ...
      if (__pyx_t_5) {
        ...
        /* "barsim/tools/cneutralize.pyx":25
 *         if isfinite[i] == 1:
 *             if ids.find(group[i]) == ids.end():
 *                 ids[group[i]] = n_ids             # <<<<<<<<<<<<<<
 *                 n_ids += 1
 ...
 */
        ...
        /* "barsim/tools/cneutralize.pyx":26
 *             if ids.find(group[i]) == ids.end():
 *                 ids[group[i]] = n_ids
 *                 n_ids += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":28
 *                 n_ids += 1
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=1] s = np.zeros(n_ids, dtype=DTYPE)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_9 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 28, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_s.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "barsim/tools/cneutralize.pyx":29
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=1] s = np.zeros(n_ids, dtype=DTYPE)
 *     cdef np.ndarray[DTYPE_t, ndim=1] s2 = np.zeros(n_ids, dtype=DTYPE)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[DTYPE_t, ndim=1] cnt = np.zeros(n_ids, dtype=DTYPE)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_7 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_s2.rcbuffer->pybuffer, (PyObject*)__pyx_t_11, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "barsim/tools/cneutralize.pyx":30
 *     cdef np.ndarray[DTYPE_t, ndim=1] s = np.zeros(n_ids, dtype=DTYPE)
 *     cdef np.ndarray[DTYPE_t, ndim=1] s2 = np.zeros(n_ids, dtype=DTYPE)
 *     cdef np.ndarray[DTYPE_t, ndim=1] cnt = np.zeros(n_ids, dtype=DTYPE)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_cnt.rcbuffer->pybuffer, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "barsim/tools/cneutralize.pyx":35
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "barsim/tools/cneutralize.pyx":36
 *     # calculate sums and stds
 *     for i in range(n):
 *         if isfinite[i] == 1:             # <<<<<<<<<<<<<<
 *             cur_id = ids[group[i]]
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      /* "barsim/tools/cneutralize.pyx":37
 *     for i in range(n):
 *         if isfinite[i] == 1:
 *             cur_id = ids[group[i]]             # <<<<<<<<<<<<<<
 *             s[cur_id] += v[i]
 ...
 */
      ...
      /* "barsim/tools/cneutralize.pyx":38
 *         if isfinite[i] == 1:
 *             cur_id = ids[group[i]]
 *             s[cur_id] += v[i]             # <<<<<<<<<<<<<<
 *             s2[cur_id] += v[i] ** 2
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_s.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_s.diminfo[0].strides) += (*__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_v.diminfo[0].strides));

      /* "barsim/tools/cneutralize.pyx":39
 *             cur_id = ids[group[i]]
 *             s[cur_id] += v[i]
 *             s2[cur_id] += v[i] ** 2             # <<<<<<<<<<<<<<
 *             cnt[cur_id] += 1
 ...
 */
      ...
      __pyx_t_16 = __pyx_v_cur_id;
      *__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_s2.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_s2.diminfo[0].strides) += pow((*__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_v.diminfo[0].strides)), 2.0);

      /* "barsim/tools/cneutralize.pyx":40
 *             s[cur_id] += v[i]
 *             s2[cur_id] += v[i] ** 2
 *             cnt[cur_id] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_17 = __pyx_v_cur_id;
      *__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_cnt.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_cnt.diminfo[0].strides) += 1.0;
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":42
 *             cnt[cur_id] += 1
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=1] res = np.full(n, np.nan)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_18 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_nan); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 42, __pyx_L1_error)
  ...
  if (PyFunction_Check(__pyx_t_8)) {
    PyObject *__pyx_temp[3] = {__pyx_t_9, __pyx_t_7, __pyx_t_18};
  ...
  #endif
  {
    __pyx_t_19 = PyTuple_New(2+__pyx_t_1); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
    if (__pyx_t_9) {
      __Pyx_GIVEREF(__pyx_t_9); PyTuple_SET_ITEM(__pyx_t_19, 0, __pyx_t_9); __pyx_t_9 = NULL;
    }
    __Pyx_GIVEREF(__pyx_t_7);
    PyTuple_SET_ITEM(__pyx_t_19, 0+__pyx_t_1, __pyx_t_7);
    __Pyx_GIVEREF(__pyx_t_18);
    PyTuple_SET_ITEM(__pyx_t_19, 1+__pyx_t_1, __pyx_t_18);
    __pyx_t_7 = 0;
    __pyx_t_18 = 0;
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_19, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_res.rcbuffer->pybuffer, (PyObject*)__pyx_t_20, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "barsim/tools/cneutralize.pyx":44
 *     cdef np.ndarray[DTYPE_t, ndim=1] res = np.full(n, np.nan)
 * 
 *     s /= cnt             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_10 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    __pyx_t_1 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_s.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_1 < 0)) {
      PyErr_Fetch(&__pyx_t_21, &__pyx_t_22, &__pyx_t_23);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_s.rcbuffer->pybuffer, (PyObject*)__pyx_v_s, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "barsim/tools/cneutralize.pyx":46
 *     s /= cnt
 * 
 *     if not norm_std:             # <<<<<<<<<<<<<<
 *         for i in range(n):
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "barsim/tools/cneutralize.pyx":47
 * 
 *     if not norm_std:
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             if isfinite[i] == 1:
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "barsim/tools/cneutralize.pyx":48
 *     if not norm_std:
 *         for i in range(n):
 *             if isfinite[i] == 1:             # <<<<<<<<<<<<<<
 *                 res[i] = v[i] - s[ids[group[i]]]
 ...
 */
      ...
      if (__pyx_t_5) {
        ...
        /* "barsim/tools/cneutralize.pyx":49
 *         for i in range(n):
 *             if isfinite[i] == 1:
 *                 res[i] = v[i] - s[ids[group[i]]]             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
        ...
        __pyx_t_25 = (__pyx_v_ids[__pyx_t_6]);
        __pyx_t_26 = __pyx_v_i;
        *__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_res.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_res.diminfo[0].strides) = ((*__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_v.diminfo[0].strides)) - (*__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_s.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_s.diminfo[0].strides)));
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":51
 *                 res[i] = v[i] - s[ids[group[i]]]
 *     else:
 *         s2 = np.sqrt((s2 - cnt * (s ** 2)) / (cnt - 1))             # <<<<<<<<<<<<<<
 *         for i in range(n):
 ...
 */
  /*else*/ {
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_19 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = PyNumber_Power(((PyObject *)__pyx_v_s), __pyx_int_2, Py_None); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_18 = PyNumber_Multiply(((PyObject *)__pyx_v_cnt), __pyx_t_8); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_18);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = PyNumber_Subtract(((PyObject *)__pyx_v_s2), __pyx_t_18); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
    __pyx_t_18 = PyNumber_Subtract(((PyObject *)__pyx_v_cnt), __pyx_int_1); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_18);
    __pyx_t_7 = __Pyx_PyNumber_Divide(__pyx_t_8, __pyx_t_18); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
    __pyx_t_18 = NULL;
    ...
    if (!__pyx_t_18) {
      __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_19, __pyx_t_7); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 51, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_GOTREF(__pyx_t_4);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_19)) {
        ...
        __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_19, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 51, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_19)) {
        PyObject *__pyx_temp[2] = {__pyx_t_18, __pyx_t_7};
        __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_19, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_18); __pyx_t_18 = 0;
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_7 = 0;
        __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_19, __pyx_t_8, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      }
    }
    ...
    __pyx_t_11 = ((PyArrayObject *)__pyx_t_4);
    {
      ...
      __pyx_t_1 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_s2.rcbuffer->pybuffer, (PyObject*)__pyx_t_11, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_1 < 0)) {
        PyErr_Fetch(&__pyx_t_23, &__pyx_t_22, &__pyx_t_21);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_s2.rcbuffer->pybuffer, (PyObject*)__pyx_v_s2, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    /* "barsim/tools/cneutralize.pyx":52
 *     else:
 *         s2 = np.sqrt((s2 - cnt * (s ** 2)) / (cnt - 1))
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             if isfinite[i] == 1:
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "barsim/tools/cneutralize.pyx":53
 *         s2 = np.sqrt((s2 - cnt * (s ** 2)) / (cnt - 1))
 *         for i in range(n):
 *             if isfinite[i] == 1:             # <<<<<<<<<<<<<<
 *                 cur_id = ids[group[i]]
 ...
 */
      ...
      if (__pyx_t_5) {
        ...
        /* "barsim/tools/cneutralize.pyx":54
 *         for i in range(n):
 *             if isfinite[i] == 1:
 *                 cur_id = ids[group[i]]             # <<<<<<<<<<<<<<
 *                 res[i] = np.float64((v[i] - s[cur_id])) / s2[cur_id]
 ...
 */
        ...
        /* "barsim/tools/cneutralize.pyx":55
 *             if isfinite[i] == 1:
 *                 cur_id = ids[group[i]]
 *                 res[i] = np.float64((v[i] - s[cur_id])) / s2[cur_id]             # <<<<<<<<<<<<<<
 *     return res
 * 
 */
        __pyx_t_19 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_19);
        __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_19, __pyx_n_s_float64); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
        __pyx_t_27 = __pyx_v_i;
        __pyx_t_28 = __pyx_v_cur_id;
        __pyx_t_19 = PyFloat_FromDouble(((*__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_v.diminfo[0].strides)) - (*__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_s.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_s.diminfo[0].strides)))); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_19);
        __pyx_t_7 = NULL;
        if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_8))) {
        ...
        if (!__pyx_t_7) {
          __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_19); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 55, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
          __Pyx_GOTREF(__pyx_t_4);
        } else {
          #if CYTHON_FAST_PYCALL
          if (PyFunction_Check(__pyx_t_8)) {
            PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_t_19};
            __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 55, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
            PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_t_19};
            __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 55, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_7); __pyx_t_7 = 0;
            __Pyx_GOTREF(__pyx_t_4);
            __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
          } else
          #endif
          {
            __pyx_t_18 = PyTuple_New(1+1); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 55, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_18);
            ...
            __pyx_t_19 = 0;
            __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_18, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 55, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_4);
            __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
          }
        }
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_29 = __pyx_v_cur_id;
        __pyx_t_8 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_s2.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_s2.diminfo[0].strides))); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_18 = __Pyx_PyNumber_Divide(__pyx_t_4, __pyx_t_8); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_30 = __pyx_PyFloat_AsDouble(__pyx_t_18); if (unlikely((__pyx_t_30 == ((npy_double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
        __pyx_t_31 = __pyx_v_i;
        *__Pyx_BufPtrStrided1d(__pyx_t_6barsim_5tools_11cneutralize_DTYPE_t *, __pyx_pybuffernd_res.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_res.diminfo[0].strides) = __pyx_t_30;
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":56
 *                 cur_id = ids[group[i]]
 *                 res[i] = np.float64((v[i] - s[cur_id])) / s2[cur_id]
 *     return res             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("barsim.tools.cneutralize.neutralize_row", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_cnt.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_6barsim_5tools_11cneutralize_1neutralize_row(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6barsim_5tools_11cneutralize_1neutralize_row(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_6barsim_5tools_11cneutralize_neutralize_row(__pyx_self, __pyx_v_v, __pyx_v_isfinite, __pyx_v_group, __pyx_v_norm_std);
...
static PyObject *__pyx_pf_6barsim_5tools_11cneutralize_neutralize_row(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_v, PyObject *__pyx_v_isfinite, PyObject *__pyx_v_group, bool __pyx_v_norm_std) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_v;
  __Pyx_Buffer __pyx_pybuffer_v;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6barsim_5tools_11cneutralize_neutralize_row __pyx_t_2;
  __Pyx_RefNannySetupContext("neutralize_row", 0);
  __pyx_pybuffer_v.pybuffer.buf = NULL;
  __pyx_pybuffer_v.refcount = 0;
  __pyx_pybuffernd_v.data = NULL;
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_6barsim_5tools_11cneutralize_neutralize_row(__pyx_v_v, __pyx_v_isfinite, __pyx_v_group, 0, &__pyx_t_2)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
...
static PyObject *__pyx_pw_6barsim_5tools_11cneutralize_3_neutralize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_6barsim_5tools_11cneutralize__neutralize(PyArrayObject *__pyx_v_v, PyArrayObject *__pyx_v_group, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6barsim_5tools_11cneutralize__neutralize *__pyx_optional_args) {
  bool __pyx_v_norm_std = ((bool)0);
  int __pyx_v_T;
  int __pyx_v_n;
  PyArrayObject *__pyx_v_res = 0;
  ...
  int __pyx_t_10;
  int __pyx_t_11;
  struct __pyx_opt_args_6barsim_5tools_11cneutralize_neutralize_row __pyx_t_12;
  __Pyx_RefNannySetupContext("_neutralize", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_norm_std = __pyx_optional_args->norm_std;
    }
  ...
  /* "barsim/tools/cneutralize.pyx":61
 * @cython.wraparound(False)
 * cpdef np.ndarray[double] _neutralize(np.ndarray v, np.ndarray group, bool norm_std=False):
 *     cdef int T = v.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int n = v.shape[1]
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":62
 * cpdef np.ndarray[double] _neutralize(np.ndarray v, np.ndarray group, bool norm_std=False):
 *     cdef int T = v.shape[0]
 *     cdef int n = v.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":64
 *     cdef int n = v.shape[1]
 * 
 *     assert T == group.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":65
 * 
 *     assert T == group.shape[0]
 *     assert n == group.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":67
 *     assert n == group.shape[1]
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=2] res = np.empty((T, n), dtype=DTYPE)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_res.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_6barsim_5tools_11cneutralize_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_res = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_res.rcbuffer->pybuffer.buf = NULL;
  ...
  /* "barsim/tools/cneutralize.pyx":68
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=2] res = np.empty((T, n), dtype=DTYPE)
 *     cdef np.ndarray[np.uint8_t, ndim=2] isfinite = np.isfinite(v).astype(np.uint8)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (!__pyx_t_3) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_2, ((PyObject *)__pyx_v_v)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_2)) {
      PyObject *__pyx_temp[2] = {__pyx_t_3, ((PyObject *)__pyx_v_v)};
    ...
    #endif
    {
      ...
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_6, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 68, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_uint8); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = NULL;
  ...
  if (!__pyx_t_4) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_6); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else {
    #if CYTHON_FAST_PYCALL
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_isfinite.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "barsim/tools/cneutralize.pyx":70
 *     cdef np.ndarray[np.uint8_t, ndim=2] isfinite = np.isfinite(v).astype(np.uint8)
 * 
 *     assert v.dtype == DTYPE             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":72
 *     assert v.dtype == DTYPE
 * 
 *     for t in range(T):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "barsim/tools/cneutralize.pyx":73
 * 
 *     for t in range(T):
 *         res[t, :] = neutralize_row(v[t, :], isfinite[t, :].tolist(), group[t, :].tolist(), norm_std=norm_std)             # <<<<<<<<<<<<<<
 *     return res
 */
    ...
    __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_isfinite), __pyx_t_6); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_tolist); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = NULL;
    ...
    __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_group), __pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    if (__pyx_t_1) {
      __pyx_t_6 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 73, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    } else {
      __pyx_t_6 = __Pyx_PyObject_CallNoArg(__pyx_t_4); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 73, __pyx_L1_error)
    }
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __pyx_t_4 = ((PyObject *)__pyx_f_6barsim_5tools_11cneutralize_neutralize_row(((PyArrayObject *)__pyx_t_3), ((PyObject*)__pyx_t_2), ((PyObject*)__pyx_t_6), 0, &__pyx_t_12)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_t); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_2 = PyTuple_New(2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_GIVEREF(__pyx_t_6);
    ...
    __pyx_t_6 = 0;
    if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_res), __pyx_t_2, __pyx_t_4) < 0)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }

  /* "barsim/tools/cneutralize.pyx":74
 *     for t in range(T):
 *         res[t, :] = neutralize_row(v[t, :], isfinite[t, :].tolist(), group[t, :].tolist(), norm_std=norm_std)
 *     return res             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_res.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("barsim.tools.cneutralize._neutralize", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_isfinite.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_6barsim_5tools_11cneutralize_3_neutralize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6barsim_5tools_11cneutralize_3_neutralize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_v = 0;
  PyArrayObject *__pyx_v_group = 0;
  bool __pyx_v_norm_std;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_neutralize (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_group)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_neutralize", 0, 2, 3, 1); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_neutralize") < 0)) __PYX_ERR(0, 60, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  3: values[2] = PyTuple_GET_ITEM(__pyx_args, 2);
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_neutralize", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 60, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("barsim.tools.cneutralize._neutralize", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_6barsim_5tools_11cneutralize_2_neutralize(__pyx_self, __pyx_v_v, __pyx_v_group, __pyx_v_norm_std);
...
static PyObject *__pyx_pf_6barsim_5tools_11cneutralize_2_neutralize(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_v, PyArrayObject *__pyx_v_group, bool __pyx_v_norm_std) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6barsim_5tools_11cneutralize__neutralize __pyx_t_2;
  __Pyx_RefNannySetupContext("_neutralize", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.norm_std = __pyx_v_norm_std;
  __pyx_t_1 = ((PyObject *)__pyx_f_6barsim_5tools_11cneutralize__neutralize(__pyx_v_v, __pyx_v_group, 0, &__pyx_t_2)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"neutralize_row", (PyCFunction)__pyx_pw_6barsim_5tools_11cneutralize_1neutralize_row, METH_VARARGS|METH_KEYWORDS, 0},
  {"_neutralize", (PyCFunction)__pyx_pw_6barsim_5tools_11cneutralize_3_neutralize, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cneutralize(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_barsim__tools__cneutralize) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "barsim.tools.cneutralize")) {
      if (unlikely(PyDict_SetItemString(modules, "barsim.tools.cneutralize", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "barsim/tools/cneutralize.pyx":4
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":8
 * cimport cython
 * 
 * DTYPE = np.float             # <<<<<<<<<<<<<<
 * ctypedef np.float_t DTYPE_t
 ...
 */
  ...
  /* "barsim/tools/cneutralize.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init barsim.tools.cneutralize", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init barsim.tools.cneutralize");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
